...
| [aws_ssm_parameter.hub_internet_gateway_id](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_nat_gateway_ids](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_private_route_table_ids](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_private_subnets](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_public_route_table_ids](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_public_subnets](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_vpc_cidr](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
| [aws_ssm_parameter.hub_vpc_id](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
...
| <a name="input_hub_internet_gateway_id"></a> [hub\_internet\_gateway\_id](#input\_hub\_internet\_gateway\_id) | ID of the hub VPC's Internet Gateway | `string` | n/a | yes |
| <a name="input_hub_nat_gateway_ids"></a> [hub\_nat\_gateway\_ids](#input\_hub\_nat\_gateway\_ids) | List of NAT Gateway IDs in the hub VPC | `list(string)` | n/a | yes |
| <a name="input_hub_private_route_table_ids"></a> [hub\_private\_route\_table\_ids](#input\_hub\_private\_route\_table\_ids) | List of private route table IDs in the hub VPC | `list(string)` | n/a | yes |
| <a name="input_hub_private_subnets"></a> [hub\_private\_subnets](#input\_hub\_private\_subnets) | List of private subnet IDs in the hub VPC | `list(string)` | n/a | yes |
| <a name="input_hub_public_route_table_ids"></a> [hub\_public\_route\_table\_ids](#input\_hub\_public\_route\_table\_ids) | List of public route table IDs in the hub VPC | `list(string)` | n/a | yes |
| <a name="input_hub_public_subnets"></a> [hub\_public\_subnets](#input\_hub\_public\_subnets) | List of public subnet IDs in the hub VPC | `list(string)` | n/a | yes |
| <a name="input_hub_vpc_cidr"></a> [hub\_vpc\_cidr](#input\_hub\_vpc\_cidr) | CIDR block of the hub VPC | `string` | n/a | yes |
| <a name="input_hub_vpc_id"></a> [hub\_vpc\_id](#input\_hub\_vpc\_id) | ID of the hub VPC | `string` | n/a | yes |
...
| <a name="output_hub_nat_gateway_ids"></a> [hub\_nat\_gateway\_ids](#output\_hub\_nat\_gateway\_ids) | List of NAT Gateway IDs in the hub VPC |
| <a name="output_hub_vpc_cidr"></a> [hub\_vpc\_cidr](#output\_hub\_vpc\_cidr) | Hub VPC CIDR block |
