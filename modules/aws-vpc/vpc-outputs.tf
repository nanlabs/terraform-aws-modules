...
output "redshift_route_table_ids" {
  description = "List of IDs of the redshift route tables"
...
output "redshift_public_route_table_association_ids" {
  description = "List of IDs of the redshift public route table association"
...
# Customer Gateways
output "cgw_ids" {
  description = "List of IDs of the customer gateway"
  value       = module.vpc.cgw_ids
}

output "cgw_arns" {
  description = "List of ARNs of the customer gateway"
